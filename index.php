				      ...
				      <p data-aos="fade-up">
				    	...
				    	<div data-aos="fade-up" class="content_buttons">
				    		...
				    		<div class="content_button_siguiente">
				    			<p v-if="parseInt(amountToDonate) && amountToDonate >= minDonation">Importe a donar $: {{ amountToDonate }}</p>
				    			<p v-else-if="amountToDonate != 'IMPORTE'" class="error_donation">El valor debe ser numérico y mayor a ${{minDonation}}.</p>
				    			<button 
				    				@click="cleanErrors()" 
